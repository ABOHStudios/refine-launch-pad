...
const getAnchorAndDir = (
  origin: NonNullable<LightRaysProps["raysOrigin"]>,
  width: number,
  height: number,
) => {
  const outside = 0.2;
  switch (origin) {
    ...
    case "right":
      return {
        anchor: [(1 + outside) * width, 0.5 * height] as [number, number],
    ...
    case "bottom-center":
      return {
        anchor: [0.5 * width, (1 + outside) * height] as [number, number],
        dir: [0, -1] as [number, number],
      };
    case "bottom-right":
      return {
        anchor: [width, (1 + outside) * height] as [number, number],
        dir: [0, -1] as [number, number],
      };
    case "top-center":
    default:
      return {
        anchor: [0.5 * width, -outside * height] as [number, number],
        dir: [0, 1] as [number, number],
      };
  }
};
